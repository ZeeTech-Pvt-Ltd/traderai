  ...
  return (
    <div className="min-h-screen pt-20 lg:pt-28 pb-16 lg:pb-24">
      <div className="max-w-[1120px] mx-auto px-4 sm:px-6">
        {/* Back */}
        <Link to="/traders" className="inline-flex items-center gap-[7px] mb-4 text-[#3d3833] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-xs font-bold no-underline hover:text-[#ff6b2b] transition-colors">
          ← Back
        </Link>

        <div className="bg-[#fafafa] dark:bg-[#2a2a2a] border border-[#e4e5e8] dark:border-[#676767] rounded-[12px] p-5 sm:p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
        {/* Profile Header */}
        <div className="flex items-center justify-between gap-5 border border-[#e4e5e8] dark:border-[#676767] rounded-[10px] bg-[#fafafa] dark:bg-[#2a2a2a] p-5 mb-[18px] max-sm:flex-col max-sm:items-stretch">
          <div className="flex items-start gap-4 min-w-0">
            <div className="w-[54px] h-[54px] flex-shrink-0 grid place-items-center bg-[#f3e6e0] dark:bg-[#ff6b2b]/20 text-[#ff6b2b] font-['Courier_New',monospace] text-xl font-bold rounded-[5px]">
              {trader.initial}
            </div>
            <div>
              <div className="flex items-center flex-wrap gap-[10px] mb-[6px]">
                ...
                <span className="bg-[#e9f0ff] dark:bg-[#ff6b2b]/15 text-[#5487df] dark:text-[#ff6b2b] px-2 py-[6px] font-['Courier_New',monospace] text-[9px]">{trader.days} days running</span>
              </div>
              <p className="text-[#756e67] dark:text-[#b1b1b1] text-xs leading-relaxed mb-[10px] m-0">{trader.description}</p>
              <div className="flex flex-wrap gap-[6px]">
                <span className="border border-[#e4e5e8] dark:border-[#676767] px-2 py-[6px] text-[#5f5852] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-[9px]">{trader.market}</span>
                <span className="border border-[#e4e5e8] dark:border-[#676767] px-2 py-[6px] text-[#5f5852] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-[9px]">{trader.strategy}</span>
                <span className="border border-[#e4e5e8] dark:border-[#676767] px-2 py-[6px] text-[#5f5852] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-[9px]">{trader.model}</span>
              </div>
            </div>
          </div>
          <button
        ...
        {/* Summary */}
        <div className="grid grid-cols-5 border border-[#e4e5e8] dark:border-[#676767] rounded-[10px] bg-[#fafafa] dark:bg-[#2a2a2a] mb-[18px] max-sm:grid-cols-2">
          {[
            ...
            <div key={i} className="min-w-0 p-4 border-r border-[#e4e5e8] dark:border-[#676767] last:border-r-0 max-sm:border-b max-sm:[&:nth-child(2n)]:border-r-0 max-sm:last:border-b-0">
              <span className="block text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">{m.label}</span>
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <select value={range} onChange={(e) => setRange(e.target.value)} className="border border-[#e4e5e8] dark:border-[#676767] bg-white dark:bg-[#222222] text-[#4d4640] dark:text-[#b1b1b1] px-2 py-[7px] font-['Courier_New',monospace] text-[9px]">
          ...
          <div className="mx-[5px] mb-2">
            <span className="block text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">Return</span>
            ...
            <span className="block text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">All Time Cumulative Return</span>
          </div>
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <span className="text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">Peak in Jul</span>
          </div>
          <div className="relative grid grid-cols-4 gap-8 items-center min-h-[215px] px-[45px] pb-[40px] border-b border-[#e4e5e8] dark:border-[#676767] max-sm:gap-[10px] max-sm:px-[10px]">
            ...
            {trader.monthly.map((m, i) => {
              ...
              return (
                <div key={i} className="relative h-[154px] flex justify-center items-center">
                  ...
                  <span className="absolute bottom-[-27px] left-0 right-0 text-center text-[#746d66] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-[9px]">{m.label}</span>
                </div>
              );
            })}
          </div>
          <div className="mt-3 space-y-0">
            {trader.monthly.map((m, i) => (
              <div key={i} className="grid grid-cols-3 py-2 px-[9px] border-b border-[#e5ddd5] dark:border-[#676767] last:border-b-0 font-['Courier_New',monospace] text-[9px]">
                <span>{m.label}</span>
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <span className="text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">Risk Profile</span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] gap-[18px]">
            {/* Gauge */}
            <div className="min-h-[220px] border border-[#e4e5e8] dark:border-[#676767] flex flex-col items-center justify-end p-[22px] overflow-hidden relative">
            ...
            {/* Risk Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 border border-[#e4e5e8] dark:border-[#676767]">
              {[
                { label: 'Max Drawdown', val: `${trader.maxDrawdown.toFixed(2)}%`, cls: 'text-[#ff3d4d]' },
                ...
                <div key={i} className="min-w-0 p-3 border-r border-[#e4e5e8] dark:border-[#676767] border-b last:border-r-0" style={{ borderRight: i % 4 === 3 ? 'none' : undefined, borderBottom: i > 3 ? 'none' : undefined }}>
                  <span className="block text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">{m.label}</span>
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <span className="text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">Equity Curve</span>
          </div>
          <div className="w-full overflow-hidden">
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <span className="text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">{trader.trades.length} trades</span>
          </div>
          <div className="border border-[#e4e5e8] dark:border-[#676767] p-[13px] mb-[14px]">
            <div className="flex h-[9px] bg-[#ebe5df] dark:bg-[#333333] overflow-hidden">
              <span className="bg-[#00bd68]" style={{ width: `${(wins / total) * 100}%` }} />
              <span className="bg-[#ff3d4d]" style={{ width: `${(losses / total) * 100}%` }} />
            </div>
            <div className="flex justify-between mt-[7px] text-[#746d66] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-[9px]">
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <div className="flex gap-[10px] text-[#6e675f] dark:text-[#b1b1b1] font-['Courier_New',monospace] text-[9px]">
          ...
          <p className="-mt-1 mb-[13px] text-[#756e67] dark:text-[#b1b1b1] text-xs">This visual pairs market price movement with model-generated buy and sell signals.</p>
          <div className="w-full overflow-hidden">
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          ...
          <div className="w-full overflow-x-auto border border-[#e4e5e8] dark:border-[#676767]">
            <table className="w-full min-w-[760px] border-collapse font-['Courier_New',monospace] text-[9px]">
              <thead><tr className="bg-[#f2f3f5] dark:bg-[#2a2a2a]">
                {['Symbol', 'Action', 'Lots', 'Entry', 'Current', 'Unrealized PNL'].map((h) => (
                  <th key={h} className="text-left p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767] text-[#8a827a] dark:text-[#b1b1b1] uppercase tracking-[.04em]">{h}</th>
                ))}
              </tr></thead>
              <tbody><tr><td colSpan={6} className="text-center text-[#8a827a] dark:text-[#b1b1b1] p-[28px]">No open positions</td></tr></tbody>
            </table>
          </div>
        </div>
        ...
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4 mb-[18px]">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            ...
            <span className="text-[#8a827a] dark:text-[#b1b1b1] uppercase font-['Courier_New',monospace] text-[8px] tracking-[.04em]">Full History</span>
          </div>
          <div className="w-full overflow-x-auto border border-[#e4e5e8] dark:border-[#676767]">
            <table className="w-full min-w-[760px] border-collapse font-['Courier_New',monospace] text-[9px]">
              <thead><tr className="bg-[#f2f3f5] dark:bg-[#2a2a2a]">
              ...
              <tbody>
                {trader.trades.slice(0, 10).map((t, i) => (
                  <tr key={i}>
                    <td className="p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767]">{t.date}</td>
                    <td className="p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767]">{t.symbol}</td>
                    <td className="p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767]">
                      <span className={`inline-block min-w-[46px] text-center px-[6px] py-[4px] ${t.action === 'BUY' ? 'text-[#00bd68] bg-[#e5f8ed] dark:bg-[#05df72]/15' : 'text-[#ff3d4d] bg-[#ffe8e8] dark:bg-[#fb2c36]/15'}`}>{t.action}</span>
                    </td>
                    <td className="p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767]">${parseFloat(t.entry).toLocaleString()}</td>
                    <td className="p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767]">${parseFloat(t.exit).toLocaleString()}</td>
                    <td className={`p-[10px_12px] border-b border-[#e3dcd4] dark:border-[#676767] ${parseFloat(t.pnl) >= 0 ? 'text-[#00bd68]' : 'text-[#ff3d4d]'}`}>{money(parseFloat(t.pnl))}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        {/* Model Transparency */}
        <div className="border border-[#e4e5e8] dark:border-[#676767] bg-[#fafafa] dark:bg-[#2a2a2a] rounded-[8px] p-4">
          <div className="flex items-center justify-between gap-[14px] mb-4">
            <h2 className="font-['Courier_New',monospace] text-[13px] m-0 tracking-[.02em]">Model Transparency</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 border border-[#e4e5e8] dark:border-[#676767]">
            <div className="flex gap-3 p-[18px]">
              ...
              <div>
                ...
                <p className="m-0 text-[#756e67] dark:text-[#b1b1b1] text-[10px] leading-relaxed">The AI trader is powered by a live language-model workflow with structured market inputs and risk-aware trade generation.</p>
              </div>
            </div>
            <div className="flex gap-3 p-[18px] border-l border-[#e4e5e8] dark:border-[#676767] max-md:border-l-0 max-md:border-t max-md:border-t-[#e4e5e8] dark:border-t-[#676767]">
              <span className="text-[#ff6b2b] text-lg">◫</span>
              <div>
                ...
                <p className="m-0 text-[#756e67] dark:text-[#b1b1b1] text-[10px] leading-relaxed">Every position is checked against exposure, drawdown and volatility limits before the simulated order is accepted.</p>
              </div>
            </div>
          </div>
          </div>
