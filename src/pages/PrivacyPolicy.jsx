              ...
              <ul className="space-y-2.5">
                {SECTIONS.map((s) => (
                  <li key={s.id}>
                    <a
                      href={`#${s.id}`}
                      className="font-mono text-xs text-[#6b6b6b] hover:text-[#ff6b2b] transition-colors leading-relaxed"
                    >
                      {s.title}
                    </a>
                  </li>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <Link
                      key={doc.label}
                      to={doc.href}
                      className="font-mono text-xs uppercase tracking-[0.1em] text-[#ff6b2b] hover:text-[#ff6b2b]/80 transition-colors py-2 px-3 rounded-lg hover:bg-[#f2f3f5]/50"
                    >
                      {doc.label}
                    </Link>
                  ))}
