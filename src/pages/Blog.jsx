...
export default function Blog() {
  return (
    <div className="min-h-screen pt-16 lg:pt-20 pb-16 lg:pb-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="mt-8 max-w-md mx-auto relative">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              <SearchIcon cn="w-4 h-4 text-[#6b6b6b]/60" />
            </div>
            <input
              type="text"
              placeholder="Search articles..."
              className="w-full h-12 pl-11 pr-4 rounded-xl border border-[#e5e5e5] bg-[#f9f9f9] font-mono text-sm text-[#1b1815] placeholder:text-[#6b6b6b]/50 focus:outline-none focus:border-[#ff6b2b] focus:ring-2 focus:ring-[#ff6b2b]/20 transition-all"
            />
          </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-6 text-center">
            <div>
              <p className="font-mono font-black text-2xl text-[#1b1815]">{POSTS.length}</p>
              <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#6b6b6b]/70 mt-1">Articles</p>
            </div>
            <div className="w-px h-10 bg-[#e5e5e5]" />
            <div>
              <p className="font-mono font-black text-2xl text-[#1b1815]">{CATEGORIES.length - 1}</p>
              <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#6b6b6b]/70 mt-1">Categories</p>
            </div>
            <div className="w-px h-10 bg-[#e5e5e5]" />
            <div>
              <p className="font-mono font-black text-2xl text-[#1b1815]">Weekly</p>
              <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#6b6b6b]/70 mt-1">Updates</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ═══ Category Tabs ═══ */}
      <section className="py-4 sm:py-5 px-4 sm:px-6 lg:px-8 border-b border-[#e5e5e5] bg-[#f9f9f9]/30">
              ...
              <button
                ...
                className={`font-mono text-[10px] uppercase tracking-[0.1em] px-3 py-1.5 rounded-md border transition-colors ${
                  cat === 'All'
                    ...
                    : 'bg-[#f9f9f9] text-[#6b6b6b] border-[#e5e5e5] hover:bg-[#f2f3f5]'
                }`}
              >
                {cat}
              </button>
      ...
      {/* ═══ Featured Post ═══ */}
      {FEATURED && (
        <section className="py-10 lg:py-14 px-4 sm:px-6 lg:px-8 border-b border-[#e5e5e5]">
          <div className="max-w-7xl mx-auto">
            <div className="bg-[#f9f9f9] border border-[#e5e5e5] rounded-xl overflow-hidden shadow-[0_1px_2px_0_rgba(0,0,0,0.05)]">
              {FEATURED.image && (
                <div className="w-full h-48 lg:h-64 overflow-hidden bg-[#F5F0EB] border-b border-[#e5e5e5]">
              ...
              <div className="p-6 lg:p-10">
                ...
                <h2 className="font-mono font-black text-2xl lg:text-3xl tracking-tight text-[#1b1815] leading-[1.1]">
                  {FEATURED.title}
                </h2>
                <p className="mt-4 text-sm text-[#6b6b6b] leading-relaxed tracking-[0.02em] max-w-3xl">
                  {FEATURED.excerpt}
                </p>
      ...
      <section className="py-10 lg:py-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="font-mono font-bold text-lg text-[#1b1815]">Latest Articles</h2>
            <p className="font-mono text-[10px] text-[#6b6b6b]/60 tracking-[0.02em]">{REGULAR.length} articles</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
            {REGULAR.map((post) => (
              <Link
                ...
                className="bg-[#f9f9f9] border border-[#e5e5e5] rounded-xl overflow-hidden hover:bg-[#f2f3f5]/50 transition-colors duration-300 shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] group"
              >
                {post.image && (
                  <div className="w-full h-36 overflow-hidden bg-[#F5F0EB] border-b border-[#e5e5e5]">
                ...
                <h3 className="font-mono font-bold text-sm lg:text-base text-[#1b1815] leading-snug group-hover:text-[#ff6b2b] transition-colors">
                  {post.title}
                </h3>
                <p className="mt-2 text-xs text-[#6b6b6b] leading-relaxed tracking-[0.02em] line-clamp-3">
                  {post.excerpt}
                </p>
                <div className="mt-4 pt-3 border-t border-[#e5e5e5] flex items-center justify-between text-[10px] font-mono uppercase tracking-[0.1em] text-[#6b6b6b]/70">
                  <span className="flex items-center gap-1.5">
      ...
      {/* ═══ Newsletter CTA ═══ */}
      <section className="py-10 lg:py-14 px-4 sm:px-6 lg:px-8 bg-[#f9f9f9]/30 border-y border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-mono font-black text-2xl lg:text-3xl tracking-tight text-[#1b1815]">
            Stay Updated
          </h2>
          <p className="mt-3 text-sm text-[#6b6b6b] leading-relaxed tracking-[0.02em] max-w-md mx-auto">
          ...
          <div className="mt-6 max-w-md mx-auto flex gap-2">
            <input
              ...
              className="flex-1 h-12 px-4 rounded-xl border border-[#e5e5e5] bg-[#f9f9f9] font-mono text-sm text-[#1b1815] placeholder:text-[#6b6b6b]/50 focus:outline-none focus:border-[#ff6b2b] focus:ring-2 focus:ring-[#ff6b2b]/20 transition-all"
            />
          ...
          <p className="mt-3 text-[10px] text-[#6b6b6b]/60 tracking-[0.02em]">
      ...
      <section className="py-10 lg:py-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-mono font-bold text-lg text-[#1b1815] mb-6 text-center">Browse by Category</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {CATEGORIES.filter((c) => c !== 'All').map((cat) => {
              ...
              return (
                <button
                  key={cat}
                  className={`inline-flex items-center gap-2 font-mono text-xs px-4 py-2 rounded-lg border transition-colors ${colorMap[cat] || 'bg-[#f2f3f5] text-[#6b6b6b] border-[#e5e5e5]'}`}
                >
                  {cat}
