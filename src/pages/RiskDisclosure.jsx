    ...
    <div className="min-h-screen pt-16 lg:pt-20 pb-16 lg:pb-24">
      ...
      <section className="py-16 lg:py-24 px-4 sm:px-6 lg:px-8 border-b border-[#e5e5e5]">
        <div className="max-w-4xl mx-auto">
          <Link to="/" className="inline-flex items-center gap-1.5 font-mono text-xs uppercase tracking-[0.1em] text-[#6b6b6b] hover:text-[#1b1815] transition-colors mb-8">
          ...
          <div className="bg-[#fb2c36]/5 border border-[#fb2c36]/20 rounded-xl p-5 lg:p-6">
            <p className="text-sm text-[#1b1815] leading-relaxed tracking-[0.02em] font-medium">
          ...
          <div className="grid lg:grid-cols-[220px_1fr] gap-10 lg:gap-14">
            <nav className="hidden lg:block sticky top-28 self-start">
              ...
              <ul className="space-y-2.5">
                {SECTIONS.map((s) => (
                  <li key={s.id}>
                    <a href={`#${s.id}`} className="font-mono text-xs text-[#6b6b6b] hover:text-[#fb2c36] transition-colors leading-relaxed">{s.title}</a>
                  </li>
                ))}
              </ul>
            </nav>
