    ...
    <section className="relative py-20 lg:py-28 px-4 lg:px-8 overflow-hidden" style={{ background: T.bg }}>
      ...
      <div className="relative max-w-4xl mx-auto rounded-3xl p-px" style={{ background: `linear-gradient(135deg, ${T.violet}55, ${T.borderStrong} 30%, ${T.blue}55)` }}>
        <div className="relative rounded-[calc(1.5rem-1px)] px-6 sm:px-10 lg:px-14 py-12 sm:py-14 lg:py-16 text-center overflow-hidden" style={{ background: `linear-gradient(160deg, ${T.card2} 0%, ${T.card} 100%)` }}>
          ...
          {/* Kicker badge */}
          <span className="relative inline-block font-mono text-[10px] uppercase tracking-[0.15em] px-3 py-1 rounded-full mb-6" style={{ background: 'rgba(123,92,255,0.14)', border: '1px solid rgba(123,92,255,0.35)', color: T.violet }}>
            Start Exploring
          </span>

          <h2 className="relative font-mono font-black text-3xl sm:text-4xl lg:text-[3.25rem] tracking-tight leading-[1.05]" style={{ color: T.text }}>
          ...
          <p className="relative mt-5 text-sm sm:text-base leading-relaxed tracking-normal max-w-2xl mx-auto" style={{ color: T.sub }}>
